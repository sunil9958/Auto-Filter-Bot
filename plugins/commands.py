...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        wish = get_wish()
        btn = [[
            InlineKeyboardButton('⚡️ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ ⚡️', url=https://t.me/UPDATES_LINK),
            InlineKeyboardButton('💡 Support Group 💡', url=https://t.me/SUPPORT_LINK)
        ]]
    ...
    if (len(message.command) != 2) or (len(message.command) == 2 and message.command[1] == 'start'):
        buttons = [[
            ...
            InlineKeyboardButton('⚡️ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ ⚡️', url=https://t.me/SvFilmsX_Official),
            InlineKeyboardButton('💡 Support Group 💡', url=https://t.me/SvFilmsX_Official)
        ],[
